...
class ApiClient {
  ...
  Future<void> saveBossRecap(int battleId,String userId,String recap) async { await http.post(Uri.parse('$baseUrl/boss/$battleId/recap').replace(queryParameters:{'user_id':userId,'recap_text':recap}),headers:_headers); }
